...
function runEvents() {
    ...
    secondCardBody.addEventListener("click",removeTodoToUI);//documente event verdik, sayfam yüklendiğinde
...
//ekrandan todo silmek
function removeTodoToUI(e){
    if(e.target.className==="fa fa-remove"){
        //Ekrandan Silme
       const todo = e.target.parentElement.parentElement; //li elementini yakaladık
       todo.remove();
